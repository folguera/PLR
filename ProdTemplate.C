...
void ProdTemplate(bool addJES, bool addJER, bool addBTag, bool addLES, bool addQ2, bool addMpts, bool addTopPt, bool splitVV,
TString outputfilename, int njetsel){
  
  TFile * inputfile       = new TFile("RootFiles/Jun18_TopPt_withVVsplitted_Pythia_DD.root");
  ...
  TH1F * NJetsNBjets__ww               = (TH1F*)inputfile->Get( "NJetsNBjets__ww" )->Clone();
  TH1F * NJetsNBjets__zz               = (TH1F*)inputfile->Get( "NJetsNBjets__zz" )->Clone();
  TH1F * NJetsNBjets__wz               = (TH1F*)inputfile->Get( "NJetsNBjets__wz" )->Clone();
  ...
  TH1F * NJetsNBjets__ww__jes__plus    = (TH1F*)inputfile->Get( "NJetsNBjets__ww__jes__plus" )->Clone();	
  TH1F * NJetsNBjets__zz__jes__plus    = (TH1F*)inputfile->Get( "NJetsNBjets__zz__jes__plus" )->Clone();	
  TH1F * NJetsNBjets__wz__jes__plus    = (TH1F*)inputfile->Get( "NJetsNBjets__wz__jes__plus" )->Clone();	
  ...
  TH1F * NJetsNBjets__ww__jes__minus   = (TH1F*)inputfile->Get( "NJetsNBjets__ww__jes__minus" )->Clone();
  TH1F * NJetsNBjets__zz__jes__minus   = (TH1F*)inputfile->Get( "NJetsNBjets__zz__jes__minus" )->Clone();
  TH1F * NJetsNBjets__wz__jes__minus   = (TH1F*)inputfile->Get( "NJetsNBjets__wz__jes__minus" )->Clone();
  ...
  TH1F * NJetsNBjets__ww__jer__plus          = (TH1F*)inputfile->Get( "NJetsNBjets__ww__jer" )->Clone();       
  TH1F * NJetsNBjets__zz__jer__plus          = (TH1F*)inputfile->Get( "NJetsNBjets__zz__jer" )->Clone();    
  TH1F * NJetsNBjets__wz__jer__plus          = (TH1F*)inputfile->Get( "NJetsNBjets__wz__jer" )->Clone(); 
  ...
  TH1F * NJetsNBjets__ww__jer__minus         = (TH1F*)inputfile->Get( "NJetsNBjets__ww" )->Clone(); 
  TH1F * NJetsNBjets__zz__jer__minus         = (TH1F*)inputfile->Get( "NJetsNBjets__zz" )->Clone(); 
  TH1F * NJetsNBjets__wz__jer__minus         = (TH1F*)inputfile->Get( "NJetsNBjets__wz" )->Clone(); 
  ...
  TH1F * NJetsNBjets__ww__btag__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__ww__btag__plus" )->Clone(); 
  TH1F * NJetsNBjets__zz__btag__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__zz__btag__plus" )->Clone(); 
  TH1F * NJetsNBjets__wz__btag__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__wz__btag__plus" )->Clone(); 
  ...
  TH1F * NJetsNBjets__ww__btag__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__ww__btag__minus" )->Clone(); 
  TH1F * NJetsNBjets__zz__btag__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__zz__btag__minus" )->Clone(); 
  TH1F * NJetsNBjets__wz__btag__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__wz__btag__minus" )->Clone(); 
  ...
  TH1F * NJetsNBjets__ww__les__plus    = (TH1F*)inputfile->Get( "NJetsNBjets__ww__les__plus" )->Clone();
  TH1F * NJetsNBjets__zz__les__plus    = (TH1F*)inputfile->Get( "NJetsNBjets__zz__les__plus" )->Clone();
  TH1F * NJetsNBjets__wz__les__plus    = (TH1F*)inputfile->Get( "NJetsNBjets__wz__les__plus" )->Clone();
  ...
  TH1F * NJetsNBjets__ww__les__minus   = (TH1F*)inputfile->Get( "NJetsNBjets__ww__les__minus" )->Clone(); 
  TH1F * NJetsNBjets__zz__les__minus   = (TH1F*)inputfile->Get( "NJetsNBjets__zz__les__minus" )->Clone(); 
  TH1F * NJetsNBjets__wz__les__minus   = (TH1F*)inputfile->Get( "NJetsNBjets__wz__les__minus" )->Clone(); 
  ...
  TH1F * NJetsNBjets__ww__q2__plus     = (TH1F*)inputfile->Get( "NJetsNBjets__ww__q2__plus" )->Clone();
  TH1F * NJetsNBjets__zz__q2__plus     = (TH1F*)inputfile->Get( "NJetsNBjets__zz__q2__plus" )->Clone();
  TH1F * NJetsNBjets__wz__q2__plus     = (TH1F*)inputfile->Get( "NJetsNBjets__wz__q2__plus" )->Clone();
  ...
  TH1F * NJetsNBjets__ww__q2__minus    = (TH1F*)inputfile->Get( "NJetsNBjets__ww__q2__minus" )->Clone();
  TH1F * NJetsNBjets__zz__q2__minus    = (TH1F*)inputfile->Get( "NJetsNBjets__zz__q2__minus" )->Clone();
  TH1F * NJetsNBjets__wz__q2__minus    = (TH1F*)inputfile->Get( "NJetsNBjets__wz__q2__minus" )->Clone();
  ...
  TH1F * NJetsNBjets__ww__mpts__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__ww__mpts__plus" )->Clone(); 
  TH1F * NJetsNBjets__zz__mpts__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__zz__mpts__plus" )->Clone(); 
  TH1F * NJetsNBjets__wz__mpts__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__wz__mpts__plus" )->Clone(); 
  ...
  TH1F * NJetsNBjets__ww__mpts__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__ww__mpts__minus" )->Clone(); 
  TH1F * NJetsNBjets__zz__mpts__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__zz__mpts__minus" )->Clone(); 
  TH1F * NJetsNBjets__wz__mpts__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__wz__mpts__minus" )->Clone(); 
  
  TH1F * NJetsNBjets__ttbar__toppt__plus  = (TH1F*)inputfile->Get( "NJetsNBjets__ttbar__toppt__plus" )->Clone(); 
  TH1F * NJetsNBjets__stop__toppt__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__stop__toppt__plus" )->Clone();  
  TH1F * NJetsNBjets__dy__toppt__plus     = (TH1F*)inputfile->Get( "NJetsNBjets__dy__toppt__plus" )->Clone();	
  TH1F * NJetsNBjets__rare__toppt__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__rare__toppt__plus" )->Clone();  
  TH1F * NJetsNBjets__fake__toppt__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__fake__toppt__plus" )->Clone(); 
  TH1F * NJetsNBjets__vv__toppt__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__vv__toppt__plus" )->Clone(); 
  TH1F * NJetsNBjets__ww__toppt__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__ww__toppt__plus" )->Clone(); 
  TH1F * NJetsNBjets__zz__toppt__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__zz__toppt__plus" )->Clone(); 
  TH1F * NJetsNBjets__wz__toppt__plus   = (TH1F*)inputfile->Get( "NJetsNBjets__wz__toppt__plus" )->Clone(); 
   
  TH1F * NJetsNBjets__ttbar__toppt__minus = (TH1F*)inputfile->Get( "NJetsNBjets__ttbar__toppt__minus" )->Clone();  
  TH1F * NJetsNBjets__stop__toppt__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__stop__toppt__minus" )->Clone(); 
  TH1F * NJetsNBjets__dy__toppt__minus    = (TH1F*)inputfile->Get( "NJetsNBjets__dy__toppt__minus" )->Clone();	
  TH1F * NJetsNBjets__rare__toppt__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__rare__toppt__minus" )->Clone(); 
  TH1F * NJetsNBjets__fake__toppt__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__fake__toppt__minus" )->Clone(); 
  TH1F * NJetsNBjets__vv__toppt__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__vv__toppt__minus" )->Clone(); 
  TH1F * NJetsNBjets__ww__toppt__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__ww__toppt__minus" )->Clone(); 
  TH1F * NJetsNBjets__zz__toppt__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__zz__toppt__minus" )->Clone(); 
  TH1F * NJetsNBjets__wz__toppt__minus  = (TH1F*)inputfile->Get( "NJetsNBjets__wz__toppt__minus" )->Clone(); 
  ...
  if(addJER){    
    ...
    if(!splitVV){
      ...
      NJetsNBjets__ww__jer__plus->Write("NJetsNBjets__ww__jer__plus");          
      NJetsNBjets__zz__jer__plus->Write("NJetsNBjets__zz__jer__plus");        
      NJetsNBjets__wz__jer__plus->Write("NJetsNBjets__wz__jer__plus");    
    }
    ...
    if(!splitVV){
      ...
      NJetsNBjets__ww__jer__minus->Write("NJetsNBjets__ww__jer__minus");       
      NJetsNBjets__zz__jer__minus->Write("NJetsNBjets__zz__jer__minus");     
      NJetsNBjets__wz__jer__minus->Write("NJetsNBjets__wz__jer__minus");
    }    
  }    
  if(addBTag){       
...
void ProdTemplate(){
 ...
 //ProdTemplate(bool addJES, bool addJER, bool addBTag, bool addLES, bool addQ2, bool addMpts, bool addTopPt, bool splitVV, TString outputfilename)
   ProdTemplate(true,        true,        true,         true,        true,        true,   false,   true,"RootFiles/Template", 0);
